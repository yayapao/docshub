...
ES5 - ES6 新老声明方式的较量，需要注意用 `var` 声明变量会发生**变量提升**，而 `const/let` 则会**暂存死区**
...
对 ES5 内的数据类型：`null`、`undefined`、`number`、`string`、`boolean`、`object`，ES6 新增了：`Set`、`Map`、`Symbol`、`BigInt` 来弥补 ES5 的不足
