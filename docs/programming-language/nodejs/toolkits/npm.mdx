...
import { HighlightWithCode, HighlightWithText } from '/src/components/Highlights/TextContent'
...
<HighlightWithText>Q: 执行脚本时，`usr/bin/env: bad interpreter: No such file or directory`？</HighlightWithText>
