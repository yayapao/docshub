...
<DocsHeader
  ...
  description="Libraries based on React eco."
  tags={['React', 'Libraries']}
  links={[
    {
...
<CommonTable data={{
  ...
  rows: [{
    name: 'stories',
    description: '描述组件的基本单元，用于展示组件的各种状态，stories 主要是编写 Meta 和 StoryObj 配置',
    exports: 'meta, named export'
  },{
    name: 'docs',
    description: '用于描述组件、组件应用文档、页面等，更多用来开发 React 页面',
    exports: '-' 
  }]
}} />
