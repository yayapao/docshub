...
<GithubRepoHeader
  ...
  avatar="/assets/showcase/joylint.jpg"
/>
...
Once you have installed joylint in your project. You can exec `npx joylint` to get some info. You will need to
...
1. review commandline interface
2. preset .git judgement
3. add update commandline
