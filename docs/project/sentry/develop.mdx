...
Sentry 内置插件系统，可以通过插件来拓展 Sentry 的功能，比如自动 TAG、Webhooks 等。这里以 [sentry/src/sentry/plugins/sentry_webhooks at master · getsentry/sentry · GitHub](https://github.com/getsentry/sentry/tree/master/src/sentry/plugins/sentry_webhooks) 来学习 Sentry 的插件系统设计。
