...
import { RemoveEvent, RemoveEventConfigInterface } from './RemoveEvent';
import { TypeEvent, TypeEventConfigInterface } from './TypeEvent';
import { SleepEvent, SleepEventConfigInterface } from './SleepEvent';
import { LoopEvent, LoopEventConfigInterface } from './LoopEvent';
...
export class AutoTyper {
  ...
  public async executeEvent(event: Event) {
    if (this.activeInterval) {
      console.warn('One Event is still acitve');
      return;
    }
