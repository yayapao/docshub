...
const HeaderTyper: React.FC<Props> = (props) => {
  ...
  return (
    <div className={clsx(styles.TyperContainer, className)}>
      <div className={styles.TyperText}>{text}</div>
      <div
        className={clsx(styles.TyperCursor, {
          [styles.Typer_Cursor_Blink]: !isTyping,
        })}
      />
    </div>
  );
